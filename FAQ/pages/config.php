...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
		<?php echo lang_get( 'plugin_format_project_text' ) ?>
	</td>
	<td class="center">
...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category" width="60%">
		<?php echo lang_get( 'plugin_format_promote_text' ) ?>
	</td>
...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category" width="60%">
		<?php echo lang_get( 'faq_view_window' ) ?>
	</td>
	<td class="center" width="20%">
...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category" width="60%">
		<?php echo lang_get( 'faq_view_check' ) ?>
	</td>
	<td class="center" width="20%">
...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
		<?php echo lang_get( 'plugin_format_threshold_text' ) ?>
	</td>
	<td class="center">
